...
window.onload = function () {
	...
	function documentActions(e) {
		...
		if (targetElement2.classList.contains("tel-form__icon")) {
			document.querySelector(".tel-form").classList.toggle("_active");
		} else if (!targetElement.closest("search-form__item") && document.querySelector(".search-form._active")) {
